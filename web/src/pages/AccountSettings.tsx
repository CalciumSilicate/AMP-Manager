...
import { ArrowRightLeft, CreditCard, RefreshCw, Shield } from 'lucide-react'
              ...
              <CardHeader>
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div className="space-y-1">
                    ...
                    <CardDescription>查看当前可用余额，并保留最直接的购买订阅入口。</CardDescription>
                  </div>
                ...
                {balanceLoading ? (
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2 rounded-lg border p-4">
                      ...
                      <p className="text-sm text-muted-foreground">余额会作为账户的可用扣费来源之一。</p>
                    </div>
