      ...
      <div className="border-b border-border/70 px-5 py-4">
        <div className="space-y-3">
          ...
          <RadioGroup
            ...
            className="max-h-28 overflow-y-auto rounded-lg border border-border/70 bg-background/60 p-2"
          >
            {searchLoading ? (
              ...
              searchResults.map((item) => (
                <label
                  key={item.id}
                  className={cn(
                    'flex cursor-pointer items-center gap-3 rounded-md px-2 py-2 text-sm hover:bg-muted/40',
        ...
        {loading ? (
          ...
          <div className="space-y-5">
            <div className="flex items-start justify-between gap-3">
              ...
              <Badge variant={detail.session.active ? 'default' : 'secondary'}>{selectedState}</Badge>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between gap-3">
                <h3 className="text-sm font-medium text-foreground">请求时间线</h3>
                <span className="text-xs text-muted-foreground">{detail.timeline.length} 条</span>
              </div>
